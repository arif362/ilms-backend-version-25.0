module Admin
  module Entities
    class LmsReportDetails < Grape::Entity
      expose :id
      expose :current_time
      expose :library
      expose :month
      ...
      expose :papers_bangla, using: Admin::Entities::Newspapers
      expose :papers_english, using: Admin::Entities::Newspapers
      expose :magazine_bangla, using: Admin::Entities::Newspapers
      expose :magazine_english, using: Admin::Entities::Newspapers
      ...
      expose :staffs, using: Admin::Entities::Staffs
      expose :present_main_staffs, using: Admin::Entities::Staffs
      ...
      def library
        {
          ...
          bn_name: object.library&.bn_name,
          email: object.library&.email,
          library_type: object.library&.library_type,
          phone: object.library&.phone,
          address: object.library&.address,
          bn_address: object.library&.bn_address,
          description: object.library&.description,
          bn_description: object.library&.bn_description,
          thana: object.library&.thana&.name,
          district: object.library&.district&.name
        }
      end
