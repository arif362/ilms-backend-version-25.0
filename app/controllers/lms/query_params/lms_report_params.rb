...
module Lms
  module QueryParams
    module LmsReportParams
      ...
      params :lms_report_create_params do
        requires :staff_id, type: Integer, allow_blank: false
        requires :month, type: DateTime, allow_blank: false
        ...
        optional :papers_bangla, type: Array[Integer], allow_blank: false
        optional :papers_english, type: Array[Integer], allow_blank: false
        optional :magazine_bangla, type: Array[Integer], allow_blank: false
        optional :magazine_english, type: Array[Integer], allow_blank: false
        ...
        optional :ict_equipment_comment, type: String, allow_blank: false
        ...
        optional :inspection_inspector_name, type: String, allow_blank: false
        optional :inspection_date, type: DateTime, allow_blank: false
        optional :inspection_purpose, type: String, allow_blank: false
        optional :inspection_notes, type: String, allow_blank: false
        ...
        requires :staff_ids, type: Array[Integer], allow_blank: false
        requires :present_main_staff_ids, type: Array[Integer], allow_blank: false
