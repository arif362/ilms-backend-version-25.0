...
module PublicLibrary
  module QueryParams
    module MembershipParams
      ...
      params :membership_create_params do
      ...
      params :security_money_payment_params do
        requires :card_delivery_type, type: String, allow_blank: false, values: RequestDetail.card_delivery_types.keys
        requires :delivery_address_type, type: String, allow_blank: false, values: RequestDetail.delivery_address_types.keys
        optional :recipient_name, type: String, allow_blank: false
        optional :recipient_phone, type: String, allow_blank: false, regexp: /(\A(\+88|0088)?(01)[3456789](\d){8})\z/
        optional :delivery_address, type: String, allow_blank: false
        optional :delivery_division_id, type: String, allow_blank: false
        optional :delivery_district_id, type: String, allow_blank: false
        optional :delivery_thana_id, type: String, allow_blank: false
      end

      params :delivery_charge_params do
